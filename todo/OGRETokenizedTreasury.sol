...
/**
 * @title Open Governance Referendum Engine Tokenized Treasury Contract
 */
contract OGRETokenizedTreasury is AccessControl {
    ...
    // TokenizedDeposit private _incomingDeposit;

    mapping(uint256 => TokenizedDeposit) public deposits; //depositTokenId => TokenizedDeposit
    ...
    constructor(address erc721FactoryAddress_) {
        ...
        _grantRole(TREASURY_OWNER, msg.sender);
        _grantRole(ALLOWED_CONTRACT, depositTokenContractAddress);
    ...
    function redeemDeposit(uint256 depositTokenId) public onlyDepositOwner(depositTokenId) {
